      ...
      <div class="registration-form-container">
        <div class="container-fluid mb-5" id="usl">
          <div class="container">
            <h1>Авторизация</h1>
            <div class="mt-3">
              <span>Забыли пароль?</span> <a href="../LERABD/reg.php" style="font-size: 24px;">Восстановить пароль</a>
            </div>
            <form method="post" action="login.php" class="needs-validation" id="registrationForm"> 
              <div class="col">
                <input type="email"  class="form-control" id="email" name="email" placeholder="Почта*" required>
                <div class="invalid-feedback">Пожалуйста, введите корректный email адрес (только английские буквы и цифры).</div>
              </div>
              <div class="col">
              ...
              <div class="col">
                <input type="text"  class="form-control" id="personalCode" name="personalCode" placeholder="Личный код">
                <div class="invalid-feedback">Личный код не соответствует требованиям.</div>
              </div>
              <div class="col-12">
                <button class="btn btn" style="background-color: #532AAE; color: white; max-width: 541px; height: 64px; width: 470px; border-radius: 20px;" type="submit">Войти в систему</button>
              </div>
            </form>
          </div>
        </div>
