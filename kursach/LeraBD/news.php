...
<header class="shadow p-3 mb-5 bg-body-tertiary rounded">
    ...
    <main>
        <div class="video-container">
            <img src="../LERABD/assets/img/uslugi/paren.png" alt="Video Thumbnail" class="custom-thumbnail">
            <div class="video-embed">
              <iframe src="../LERABD/assets/video/aeskulap_stab1.mp4" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
            </div>
          </div>
          ...
          <div class="container" style="margin-bottom: 114px; display: flex; justify-content: center;">
            <div class="card-group">
                <div class="row">
                <div class="col">
                  <a href="../LERABD/stat.php" style="text-decoration: none; color:black;">
                      <div class="card1">
                          <img src="../LERABD/assets/img/news/image.png" class="card-img-top1" alt="...">
                          <div class="card-body1">
                              <h5 class="card-title">5 привычек для укрепления иммунитета</h5>
                          </div>
                          <div class="card-footer">
                              <small class="text-body-secondary">4 января</small>
                          </div>
                      </div>
                  </a>
                </div>
                    <div class="col">
                    <a href="../LERABD/stat2.php" style="text-decoration: none; color:black;">
                        <div class="card1">
                            <img src="../LERABD/assets/img/news/image (1).png" class="card-img-top1" alt="...">
                            <div class="card-body1">
                              <h5 class="card-title">10 простых шагов к здоровому образу жизни</h5>
                            </div>
                            <div class="card-footer">
                              <small class="text-body-secondary">4 января</small>
                            </div>
                    ...
                    <a href="../LERABD/stat.php" style="text-decoration: none; color:black;">
                        <div class="card1">
                            <img src="../LERABD/assets/img/news/image (2).png" class="card-img-top1" alt="...">
                            <div class="card-body1">
                              <h5 class="card-title">5 привычек для укрепления иммунитета</h5>
                            </div>
                            <div class="card-footer">
                ...
                <div class="row">
                    <div class="col">
                    <a href="../LERABD/404.php" style="text-decoration: none; color:black;">
                        <div class="card1">
                            <img src="../LERABD/assets/img/news/image (3).png" class="card-img-top1" alt="...">
                            <div class="card-body1">
                              <h5 class="card-title">Как правильно питаться: советы для занятых людей</h5>
                            </div>
                            <div class="card-footer">
                              <small class="text-body-secondary">4 января</small>
                            </div>
                    ...
                    <a href="../LERABD/404.php" style="text-decoration: none; color:black;">
                        <div class="card1">
                            <img src="../LERABD/assets/img/news/image (4).png" class="card-img-top1" alt="...">
                            <div class="card-body1">
                              <h5 class="card-title">Сон и здоровье: как улучшить качество сна</h5>
                            </div>
                            <div class="card-footer">
                              <small class="text-body-secondary">4 января</small>
                            </div>
                    ...
                    <a href="../LERABD/404.php" style="text-decoration: none; color:black;">
                        <div class="card1">
                            <img src="../LERABD/assets/img/news/image (5).png" class="card-img-top1" alt="...">
                            <div class="card-body1">
                              <h5 class="card-title">Психическое здоровье: простые техники для снятия стресса</h5>
                            </div>
                            <div class="card-footer">
                              <small class="text-body-secondary">4 января</small>
                            </div>
