...
<body>
    ...
    <main style="margin-bottom: 104px;">
        <div class="container-fluid mb-5" id="usl">
            <h1>Отзывы от наших клиентов</h1>
          </div>
          <div class="container d-flex flex-column border border-primary rounded" style="margin-bottom: 50px; padding-top: 25px; padding-left: 52px; padding-right: 34px; padding-bottom: 25px; "> 
            <div class="d-flex justify-content-between align-items-center mb-2">  
              <span>Дракуль Михоук 21 января 2023</span>
            ...
            <span class="review-text mb-2">Хочу выразить свою искреннюю благодарность медицинской клинике! Профессионализм врачей и внимательное отношение к пациентам сделали мой визит комфортным и приятным. </span>
          </div>
          <div class="container d-flex flex-column border border-primary rounded" style="margin-bottom: 50px; padding-top: 25px; padding-left: 52px; padding-right: 34px; padding-bottom: 25px;"> 
            <div class="d-flex justify-content-between align-items-center mb-2">  
              <span>Николай Миронов 22 января 2023</span>
              <div class="rating-result"> 
                <span class="active"></span>
                <span class="active"></span>
                <span class="active"></span>
            ...
            <span class="review-text mb-2">Всё быстро,персонал высококвалифицированный,культура общения с клиентами на высоте,специалисты супер,чистота идеальная. Спасибо за КТ носовых пазух! Стабильности и процветания Вам! </span>
          </div>
          <div class="container d-flex flex-column border border-primary rounded" style="margin-bottom: 50px; padding-top: 25px; padding-left: 52px; padding-right: 34px; padding-bottom: 25px;"> 
            <div class="d-flex justify-content-between align-items-center mb-2">  
              <span>Арсений Попов 23 января 2023</span>
              <div class="rating-result"> 
                <span class="active"></span>
                <span class="active"></span>
                <span class="active"></span>
            ...
            <span class="review-text mb-2">Центр удобно расположен. Недалеко от метро. Современное оборудование и хорошие специалисты. Всё организовано чётко. Цена и качество меня устроили. </span>
          </div>
    </main>
